Public Class frmTrans
    ...
    Private Sub cmdStart_Click(ByVal sender As System.Object, e As System.EventArgs) Handles cmdStart.Click
        '单击“转换”按钮，调用Trans过程转换
        Dim i As Integer
    ...
    End Sub
    Private Sub txt_Input_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtInput.Leave
        Dim Response As Integer
        If IsNumeric(txtInput.Text) = True Then   '判断输入的是否为数组
            Number = Val(txtInput.Text)
        Else
            Response = MsgBox("输入的数据出错！", vbOKOnly + vbCritical, "数据出错")
            txtInput.Focus()
        End If
    End Sub
End Class
